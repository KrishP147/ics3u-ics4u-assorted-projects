...
public class DogSimple {
	...
	public DogSimple (String name, String breed, String color, int age, ImageIcon photo) { 
	...
	//NOTE: Each object has a set of so called setters & getters methods
	...
	public static void printDogInfo(DogSimple d1, DogSimple d2, DogSimple d3) {
	...
	public static int chooseDoggy(DogSimple d1, DogSimple d2, DogSimple d3) {// This method chooses which procedure to go through, using option buttons
		int intInput;
	...
	public static void main(String[] args) {
		...
		DogSimple d1 = new DogSimple("Simba", "Pug", "Fawn", 6, new ImageIcon ("Desktop.png"));
		DogSimple d2 = new DogSimple("Cookie", "Poodle", "Black", 1, new ImageIcon ("Poodle.png"));
		DogSimple d3 = new DogSimple("Becky", "German Shepherd", "Black and Fawn", 13, new ImageIcon ("German Shepherd.png"));
