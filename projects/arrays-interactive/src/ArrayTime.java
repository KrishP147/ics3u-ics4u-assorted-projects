 ...
 * It attempts to use a timer, however, the timer is inconsistent
...
public class ArrayTime	{  
	...
	public static double binaryTime = 0; //static variable created for binary time, same reasoning as above
	...
	public static int numOfLinearIter = 0; //tracks the number of iterations through the array; it is a static variable modified
									...
									//numOfIter as well. Therefore, this variable is declared as static
	public static double linearTime = 0; //static variable created for linear time, same reasoning as above
	...
	public static int[] initializeArray() {
	    int[] arr = new int [1024];  //array is sorted through initialization - 2 to 1024
	...
	public static int binarySearch(int arr[], int key){ 
		...
		binaryTime = (System.nanoTime() - startTime)/1e3;
		return index;
	} 
	...
	public static int linearSearch(int arr[], int key){ 
		...
		linearTime = (System.nanoTime() - startTime)/1e3;
		return index;
	}  
	
	public static void displayResults(final int KEY, int keyIndex, int[] arr) { // this method displays the results of the searches, along with iterations and time
		
		String title = "BINARY SEARCH RESULTS";
		...
		String message3 = "The binary process took " + numOfBinaryIter + " iterations!";
		String message2 = "The linear process took " + numOfLinearIter + " iterations!";
		String message4 = "The binary process took " + binaryTime + " microseconds!"; // displays time
		String message5 = "The linear process took " + linearTime + " microseconds!"; // displays time
